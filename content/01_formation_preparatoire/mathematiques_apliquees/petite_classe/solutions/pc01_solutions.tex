...
$$
v_n = \prod_{k=1}^n cos\left(\frac{\theta}{2^k}\right) \Rightarrow 2^n \sin(\frac{\theta}{2})v_n = \sin(\theta) \Rightarrow v_n = \frac{\sin(\theta)}{2^n \sin(\frac{\theta}{2^n})} \to \frac{\sin(\theta)}{\theta} 
$$
...
$$
v_n = \prod_{k=1}^n cosh\left(\frac{\theta}{2^k}\right) \Rightarrow 2^n \sinh(\frac{\theta}{2})v_n = \sinh(\theta) \Rightarrow v_n = \frac{\sinh(\theta)}{2^n \sinh(\frac{\theta}{2^n})} \to \frac{\sinh(\theta)}{\theta} 
$$
